...
require('yargs')
    ...
    .command(['component <component>', 'c'], 'create react-component \n(example: node create-cmp.js c footer --hf --st=active --fr -r -f=. --cs)', 
    {}, (yargs) => {
...
fs.appendFile(`${yargs.folder ? yargs.folder : ""}/${Component}.js`, 
 ...
 `)
 .then (function() {
    fs.appendFile(`${yargs.folder ? yargs.folder : ""}/${Component}.scss`, "")
 })
